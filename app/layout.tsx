        ...
        <div className="sticky top-0 z-50 bg-[#f4edc9] shadow-[0_2px_10px_rgba(0,0,0,0.08)]">
          <header className="bg-[#f4edc9] border-b border-gray-300">
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-6">
              {/* Top slogans */}
              <div className="absolute left-4 top-2  font-medium font-semibold text-[#0f6b3a] drop-shadow-[0_0_6px_rgba(15,107,58,0.35)]">
                வாழ்க வையகம்
              </div>
              <div className="absolute right-4 top-2  font-medium font-semibold text-[#0f6b3a] drop-shadow-[0_0_6px_rgba(15,107,58,0.35)]">
                வாழ்க வளமுடன்
              </div>
              ...
              <div className="flex justify-between items-center px-6 md:px-12">
                <img
                  src="/logo-wcsc.png"
                  alt="WCSC SKY"
                  className="h-[56px] md:h-[100px] w-auto drop-shadow-[0_4px_6px_rgba(0,0,0,0.25)]"
                />
                <img
                  src="/logo-skyyoga.png"
                  alt="SKY Yoga"
                  className="h-[56px] md:h-[120px] w-auto drop-shadow-[0_4px_6px_rgba(0,0,0,0.25)]"
                />
              </div>
            </div>
